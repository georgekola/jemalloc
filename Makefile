...
srcroot := 
objroot := 
abs_srcroot := /home/kola/Voxer/thirdparty/tmp/redis/deps/jemalloc/
abs_objroot := /home/kola/Voxer/thirdparty/tmp/redis/deps/jemalloc/

# Build parameters.
CPPFLAGS :=  -D_POSIX_PTHREAD_SEMANTICS -D_REENTRANT -I$(srcroot)include -I$(objroot)include
CFLAGS := -std=gnu99 -Wall -pipe -g3 -fvisibility=hidden -O3 -funroll-loops
LDFLAGS := 
EXTRA_LDFLAGS := 
LIBS :=  -lposix4 -lsocket -lnsl -lpthread
RPATH_EXTRA := 
SO := so
IMPORTLIB := so
O := o
